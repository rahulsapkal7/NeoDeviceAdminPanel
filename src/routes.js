...
const AddDevice = React.lazy(() => import('./views/Device/AddDevice'));
const EditDevice = React.lazy(() => import('./views/Device/EditDevice'));
...
const routes = [
  ...
  { path: '/category/addCategory', name: 'AddCategory', component: AddCategory },
  { path: '/category/editCategory/:id', name: 'EditCategory', component: EditCategory },
  { path: '/category/categoryList', name: 'CategoryList', component: CategoryList },

  { path: '/device/addDevice', name: 'AddDevice', component: AddDevice },
  { path: '/device/editDevice/:id', name: 'EditDevice', component: EditDevice },
